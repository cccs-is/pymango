...
# -*- coding: utf-8 -*-
#
# pymango documentation build configuration file
#
...
_version_py = os.path.join(repo, 'pymango', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'pymango.tex', 'pymango Documentation',
     'cccs-is', 'manual'),
]
